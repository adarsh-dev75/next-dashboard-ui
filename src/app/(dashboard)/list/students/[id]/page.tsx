        ...
        <div className="flex flex-col lg:flex-row gap-4">
            <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                ...
                <div className="w-2/3 flex flex-col justify-between gap-4">
                    ...
                    <p className="text-sm text-gray-500">This is about a student description.</p>
        ...
        <div className="bg-white p-4 rounded-md">
            <div>
                ...
                <div className="flex mt-4 flex-wrap text-xs text-gray-500 gap-4">
                    <Link className="p-3 bg-lamaYellowLight border border-slate-50 rounded-md" href="/">Student&apos;s Teachers</Link>
                    <Link className="p-3 bg-lamaPurpleLight border border-slate-50 rounded-md" href="/">Student&apos;s Lessons</Link>
                    <Link className="p-3 bg-pink-50 border border-slate-50 rounded-md" href="/">Student&apos;s Exams</Link>
                    <Link className="p-3 bg-lamaSkyLight border border-slate-50 rounded-md" href="/">Student&apos;s Assignments</Link>
                    <Link className="p-3 bg-lamaSkyLight border border-slate-50 rounded-md" href="/">Student&apos;s Results</Link>
                </div>
            </div>
        </div>
        <PerformanceChart/>
